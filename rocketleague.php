...
<head>
    ...
    <META NAME="Title" CONTENT="Rocket League | Gstats Network">
    <title>Rocket League | Gstats Network</title>
    <link rel="icon" type="image/x-icon" href="assets/images/favicon.png">
    <META NAME="Keywords" CONTENT="rokcet rocket league server status r6">
    <META NAME="Description" CONTENT="View the live status of services and servers for Rocket League and check if servers are down">
...
<body>
  ...
  <header class='siteHeader'>
    <div class='container'>
      <img class="img-resposive" src="assets/images/rocket-league.svg" style="margin-bottom: -10px; margin-right: 10px; display: inline; width: 150px">
    </div>
  </header>
  ...
  <?php
          ...
          //-----------------------------------------------------------------------------------------------------//
              include 'apis/rocketleague-api.php';

              if (strpos($responsenojson, 'Operational')) { 
                ...
                echo "<section class='col-md-12 ongoingIssues'>
                  <a href='' class='issueBanner issueBanner--maintenance'>
                    <p class='issueBanner__state'>Monitoring</p>
                    <span class='server-status' type='slow' style='margin-left: 20px;'></span><p style='margin-left: 20px;'>Some services are not running correctly</p>
                  </a>
                </section>";
              }
    ...
    <section class='col-md-12 serviceGroup'>
    ...
    <ul class='serviceList serviceGroup__list'>
        <?php
          ...
          //-----------------------------------------------------------------------------------------------------//
              ...
              foreach($response['RocketLeague'] as $key2 => $val) {
